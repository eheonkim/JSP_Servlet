...
public class EditController extends HttpServlet
{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException
	{
		// 디렉토리의 물리적경로 얻어오기 파일업로드 제한 용량 얻어오기 
		...
		String prevOfile = mr.getParameter("preveOfile");
		String prevSfile = mr.getParameter("preveSfile");
...
//		사용자가 직접 입력한 값
		...
		/*
		 	패스워드의 경우 인증완료시 session영역에 저장해ㅏ둔것을 얻어온다.
