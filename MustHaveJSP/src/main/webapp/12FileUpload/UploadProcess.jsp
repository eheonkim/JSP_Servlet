...
try
{
	...
	*/
	...
	/*
		...
		잘라낸다. 확장자는 파일의 용도로를 나타내는 부분이므로 중요하다.
	...
	*/
	...
	/*
		...
		윈도의 경우 \(역슬래쉬), 리눅스의 경우 /(슬러쉬)를 자동으로
	...
	*/
	...
	/*
		파일을 제외한 나머지 폼값을 받는다. 단 이때request내장객체를 통해서가 아니라
		mr객체를 통해 받아야 하므로 주의해야 한다. 객체는 다르지만 폼값을 받기위해
		메서드명은 동일하다
	*/
...
{
	/*
		파일업로드에 실패한 경우에는 request영엑 에러메세지를 저장한 후 업로드 폼으로 
		포워드한다.
	*/
	e.printStackTrace();
