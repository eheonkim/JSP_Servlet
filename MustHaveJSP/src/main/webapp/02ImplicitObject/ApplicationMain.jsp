...
<body>
	...
	<!--  web.xml에 ㅡcontext-param>으로 설장한 값을 내장객체를 통해 -->
	초기화 매개변수 : <%= application.getInitParameter("INIT_PARAM") %>
	
	<!--  
		이클립스에서는 우리가 직접 작성한 파일을 실행하지 않고 .metadata
		디렉토리 하위에 프로젝트와 동일한 톰켓 환경을 만들어서 복사본 
		파일을 실행한다. 따라서 아래의 물리적 경로는 .metadata하위의 경로가 출력된다.
	 -->
	...
	/*
		...
		내장객체는 _jsapService()메서드내애서 생성된 지역변수이므로 더 넓은 지역인 
	...
	*/
	...
	public String useImplicitObject(ServletContext app) {
		/*
			방법2 : 스트립트렛에서 메서드를 호출할때 application 냉격ㄹ체르
		*/
