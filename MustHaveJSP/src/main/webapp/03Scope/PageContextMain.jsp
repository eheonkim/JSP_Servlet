...
/*
	...
	object 기반으로 저장되므로 차후 값을 읽을때는 해당 타입으로 형 변환
	해야한다.
*/
%>
<!DOCTYPE html>
...
<body>
	...
	// Person()과 같이 개발자가 정의한 클래스는 원래의 타입으로 형변환한다.
	...
	<!-- 
		...
		포함시킨 후 컴파일을 진행한다. 따라서 동일한 페이지로 취급되므로 page영역이 그대로
		공유된다.
	...
	<!-- 
		...
		즉, 아래의 링크를 통해 이동한 페이지에 내용이 출력된다.
	 -->
