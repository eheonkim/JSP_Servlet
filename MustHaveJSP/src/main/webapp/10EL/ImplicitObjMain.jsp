...
<!-- 	</ul> -->
	...
	<!-- 
		...
		모두 동일한 패턴으로 "영역명Scop"와 같은 형태로 되어있다.
	...
	<ul>
		...
		<li>세션 영역 : ${ sessionScop.scopeValue }</li>
		<li>애플리케이션 영역 : ${ applicationScop.scopeValue }</li>
	</ul>
	
	<!--  
		만약 영역명 지정없이 속성을 읽을때는 가장 좁은 영역을 우선으로 출력한다.
		즉, 여기서는 page영역의 속성을 출력하게 된다. 실무에서는 동일한 
		속성명으로 저장ㅎ나ㅡㄴ 경우가 거의 없으므로 대부분 이와같이
		사용할 수 있다.
	 -->
