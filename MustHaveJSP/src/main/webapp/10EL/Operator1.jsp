...
<body>
	<h3>변수 선언 및 할당</h3>
	<!--  
		EL및 JSTL은 영역에 저장된 속성들은 이용해서 연산하거나 출력한다.
		따라서 스크립트렛에서 선언한 변수는 EL에서 사용할수 없다.
	 -->
	 <!--  num1은 아무값도 출력되지 않는다.  -->
	스크립틀릿에서 선언한 변수 : ${ num1 } <br />
	page 영역에 저장된 변수 : ${ num2 } <br />
	<!-- 
		톰켓8.0부터는 EL에서 변수할당을 할수 있다. 하지만 변수할당과 동시에 출력되므로,
	...
	<h3>+ 연산자는 덧셈만 가능</h3>
	num1 + "34" : ${ num1 + "34" } <br />
	<!--  하지만 숫자와 문자열 혹은 문자열과 문자열의 경우에는 연산이 불가능하므로 예외가
	발생된다. -->
	num2 + "이십" : \${num2 + "이십" } <br />
	"삼십" + "사십" : \${ "삼십" + "사십" } <br />
